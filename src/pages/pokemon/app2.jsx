...
function P_App2(){
  ...
  return(
    <div>
      <button class = "btn btn-success "onClick={gerarPokemon}>Novo Pokemon</button>
      ...
      />
      <br />
      <h3>Aviso: Som baixo, aumente no máximo o volume para conseguir escutar o(a) {pokemon.nome}</h3>
       <button class="btn btn-primary" onClick={() => pokemon.tocarSom()}>Tocar</button>
      <hr/>
      <h2>Moves</h2>
      <ul>
       <li>{pokemon.move1}</li>
